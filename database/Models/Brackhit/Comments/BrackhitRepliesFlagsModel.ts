...
export class BrackhitRepliesFlagsModel extends Model {
  ...
  static get tableName() {
    return 'labl.brackhit_replies_flags';
  }
  ...
  static get relationMappings() {
    return {
      comment: {
        ...
        join: {
          from: 'labl.brackhit_replies_flags.commentId',
      ...
      userProfile: {
        ...
        join: {
          from: 'labl.brackhit_replies_flags.userId',
